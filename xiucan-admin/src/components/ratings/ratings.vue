      ...
      <div class="overview">
        ...
        <div class="overview-right">
          ...
          <div class="delivery-wrapper">
            ...
            <span class="delivery">{{seller.deliveryTime}}{{ $t('lang.minute') }}</span><!-- 分钟 -->
          </div>
        </div>
      </div>
      <split></split>
...
//  const ERR_OK = 0;   by xiaozc
  ...
  export default {
    ...
    created() {
      var restUrl = 'http://www.xiucan.com/api/v2/getcloudbasedata/' + this.$root.urlParam.token;   // 'static/data.json'
