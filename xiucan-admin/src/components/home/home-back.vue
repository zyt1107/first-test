 ...
 <div class="banner">
        <div class="slide" id="slide2">
            <ul>
                <li>
                    <a href="#">
                        <img src="http://www.xiucan.com/admin/static/image/1.jpg" alt="">
                    </a>
        ...
        <div class="tab-item">
            ...
            <router-link to="register">
              <div class="weui-btn weui-btn_primary" style="margin-top: 15px; width: 90%; background-color: #00A0DC;">我要开店</div>
            </router-link>            
        </div>
        <div class="weui-cells">
        	<!-- <router-link to="/orderList"> -->
				<a class="weui-cell homeList weui-cell_access" href="javascript:;" @click="stayForDialog = true">
	                <div class="weui-cell__hd orders"></div>
	                <div class="weui-cell__bd">
	                    <p>订单管理</p>
	                </div>
	                <div class="weui-cell__ft">订单管理</div>
            	</a>
             <!-- </router-link> -->
            <!-- <router-link to="/member"> -->
                ...
                <div class="weui-cell__ft">会员卡管理</div>
            	</a>
            <!-- </router-link> -->
            <!-- <router-link to="coupons"> -->
                ...
                <div class="weui-cell__ft">优惠券管理</div>
            </a>
            <!-- </router-link> -->
            <!-- <router-link to="giftcard"> -->
                ...
                <div class="weui-cell__ft">礼品卡管理</div>
            </a>
            <!-- </router-link> -->
        </div>
        ...
        <!-- 敬请期待 start -->
        <div v-if="stayForDialog">
            <div class="weui-mask"></div>
            <div class="weui-dialog">
                <div class="weui-dialog__bd">请先开店！</div>
                <div class="weui-dialog__ft">
                    <a href="javascript:;" class="weui-dialog__btn weui-dialog__btn_primary" @click = "stayForDialog = false">确定</a>
                </div>
            </div>
        </div>
        <!-- 敬请期待 end -->
